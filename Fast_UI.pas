      ...
      with item_fx_arr[i] do
        begin
          ...
          if (TRGBA(fx_color0).a<>0) or
            ...
            begin
              fx_style0_:=fx_style0+11*Byte(TRGBA(fx_color0).a<>TRGBA(fx_color1).a);
              ...
              case fx_style0_ of
                ...
                07:
                  if b2 then
                    ...
                    case fx_style1 of
                      0: PPRandNoiseDec (oc_bmp_ptr0,oc_w,rct2,@RandNoise0Dec,TRGBA(fx_color0).r{255},TRGBA(fx_color1).r{001},TRGBA(fx_color0).a);
                      1: PPRandNoiseDec (oc_bmp_ptr0,oc_w,rct2,@RandNoise1Dec,TRGBA(fx_color0).r{001},TRGBA(fx_color1).r{001},TRGBA(fx_color0).a);
                      2: PPRandNoiseDec (oc_bmp_ptr0,oc_w,rct2,@RandNoise2Dec,TRGBA(fx_color0).r{001},TRGBA(fx_color1).r{001},TRGBA(fx_color0).a);
                      3: PPRandNoiseDec (oc_bmp_ptr0,oc_w,rct2,@RandNoise3Dec,TRGBA(fx_color0).r{127},TRGBA(fx_color1).r{000},TRGBA(fx_color0).a);
                      4: PPRandNoiseDec (oc_bmp_ptr0,oc_w,rct2,@RandNoise4Dec,TRGBA(fx_color0).r{000},TRGBA(fx_color1).r{002},TRGBA(fx_color0).a);
                    end;
                08:
                  if b2 then
                    PPBlurRGB9          (oc_bmp_ptr0,oc_w,rct2,TBlurType(fx_style1)                                                             )
                  else
                    PPBlurRGB9Dec       (oc_bmp_ptr0,oc_w,rct2,TBlurType(fx_style1),                                          TRGBA(fx_color0).a);
