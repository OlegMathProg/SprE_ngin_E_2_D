...
type
  ...
  TUIImgScrollBox =class(TUIObjManager) {$region -fold}
    public
      ...
      procedure   SetTxtPropDefault0;
      procedure   SetTxtPropDefault1;
      ...
      procedure   SetPosShiftSize     (var   pvt              :TPoint;
                                       ...
                                       const scale_const      :boolean=True;
...
begin
 ...
 {scr_bar_v.
  ...
  item_rct_default        :=PtBounds (0,0,100,100);
  item_rct_size_inc       :=16;
  item_rct_f              :=PtBoundsF(item_rct_default.left,item_rct_default.top,item_rct_default.width,item_rct_default.height);
  item_rct_prev_f         :=item_rct_f;
  item_rct                :=item_rct_default;
  ...
  pvt                     :=Default(TPoint);
  shift                   :=ss2Empty;
  SetPosShiftSize(pvt,dir,True,False);
end; {$endregion}
...
procedure   TUIImgScrollBox.SetTxtPropDefault0;                                                                                                                     {$region -fold}
begin
...
procedure   TUIImgScrollBox.SetTxtPropDefault1;                                                                                                                     {$region -fold}
begin
  ...
  begin
    with sprite_arr [(images_inds_arr_ptr+i)^],fast_image_data,fast_image_proc_var do
      with item_fx_arr[i] do
        if (TRGBA(fx_color0).a<>0) or
           (TRGBA(fx_color1).a<>0) then
          begin
            fx_color0_:=SetColorInv(fx_color0);
            fx_color1_:=SetColorInv(fx_color1);
            b2        :=(TRGBA     (fx_color0).a=MAXBYTE) and
                        (TRGBA     (fx_color1).a=MAXBYTE);
            if          (TRGBA     (fx_color0).a<>
                         TRGBA     (fx_color1).a) then
              fx_style0_:=fx_style0+11
            else
              begin
                if ((fx_color0 and $00FFFFFF)<>
                    (fx_color1 and $00FFFFFF)) and
                    (fx_style0 in [0,1,6]) then
                  fx_style0_:=fx_style0+11
                else
                  fx_style0_:=fx_style0;
              end;
            ...
            case fx_style0_ of
              00:
                if b2 then
                  PPFloodFill         (oc_bmp_ptr0,oc_w,rct2,fx_color0_                                                                       )
                else
                  PPAlphaBlend        (oc_bmp_ptr0,oc_w,rct2,fx_color0_ ,                                                   TRGBA(fx_color0).a);
              01:
                if b2 then
                  PPAdditive          (oc_bmp_ptr0,oc_w,rct2,fx_color0_                                                                       )
                else
                  PPAdditiveDec       (oc_bmp_ptr0,oc_w,rct2,fx_color0_ ,                                                   TRGBA(fx_color0).a);
              02:
                if b2 then
                  PPInverse           (oc_bmp_ptr0,oc_w,rct2                                                                                  )
                else
                  PPInverseDec        (oc_bmp_ptr0,oc_w,rct2,                                                               TRGBA(fx_color0).a);
              03:
                if b2 then
                  PPFloodFill         (oc_bmp_ptr0,oc_w,rct2,clWhite                                                                          )
                else
                  PPHighlight         (oc_bmp_ptr0,oc_w,rct2,                                                               TRGBA(fx_color0).a);
              04:
                if b2 then
                  PPFloodFill         (oc_bmp_ptr0,oc_w,rct2,clBlack                                                                          )
                else
                  PPDarken            (oc_bmp_ptr0,oc_w,rct2,                                                               TRGBA(fx_color0).a);
              05:
                if b2 then
                  case fx_style1 of
                    0: PPGrayscaleR   (oc_bmp_ptr0,oc_w,rct2                                                                                  );
                    1: PPGrayscaleG   (oc_bmp_ptr0,oc_w,rct2                                                                                  );
                    2: PPGrayscaleB   (oc_bmp_ptr0,oc_w,rct2                                                                                  );
                  end
                else
                  case fx_style1 of
              ...
              06:
                if b2 then
                  PPMonoNoise         (oc_bmp_ptr0,oc_w,rct2,fx_color0_                                                                       )
                else
                  PPMonoNoiseDec      (oc_bmp_ptr0,oc_w,rct2,fx_color0_,                                                    TRGBA(fx_color0).a);
              07:
                if b2 then
                  PPRandNoise         (oc_bmp_ptr0,oc_w,rct2,fx_style1,     TRGBA(fx_color0).r{255},TRGBA(fx_color1).r{001}                   )
                else
                  PPRandNoiseDec      (oc_bmp_ptr0,oc_w,rct2,fx_style1,     TRGBA(fx_color0).r{255},TRGBA(fx_color1).r{001},TRGBA(fx_color0).a);
              08:
                if b2 then
                  PPBlur8             (oc_bmp_ptr0,oc_w,rct2,TBlurType(fx_style1)                                                             )
                else
                  PPBlur8Dec          (oc_bmp_ptr0,oc_w,rct2,TBlurType(fx_style1),                                          TRGBA(fx_color0).a);
              09: PPContrast1         (oc_bmp_ptr0,oc_w,rct2,                                                               TRGBA(fx_color0).a);
              10:
                if b2 then
                  PPGamma             (oc_bmp_ptr0,oc_w,rct2,               TRGBA(fx_color0).r{005}{127}                                      )
                else
                  PPGammaDec          (oc_bmp_ptr0,oc_w,rct2,               TRGBA(fx_color0).r{005}{127},                   TRGBA(fx_color0).a);
              11:
                if b2 then
                  PPGrVMonochrome     (oc_bmp_ptr0,oc_w,rct6,ui_grad_prop.grad_prop,                     oc_w)
                else
                  PPGrVAlphaBlend     (oc_bmp_ptr0,oc_w,rct6,ui_grad_prop.grad_prop,                     oc_w);
              ...
              18:
                begin
                  ...
                  PPGrVRandNoise      (oc_bmp_ptr0,oc_w,rct6,ui_grad_prop.grad_prop,fx_style1,           oc_w);
                end;
              19: PPGrVBlurRGB9       (oc_bmp_ptr0,oc_w,rct6,ui_grad_prop.grad_prop,TBlurType(fx_style1),oc_w);
  ...
  if (items_cnt<>0) then
    ...
    with txt_label_prop do
      begin
        ...
        rct_mrg1    :=PtRct(10,0,rct_mrg0.width-10,text_height_{+2});
        Text(0,
             rct7.top,
             oc_bmp_ptr0,
             oc_w,
...
procedure   TUIImgScrollBox.SetPosShiftSize     (var   pvt        :TPoint; var dir:TMovingDirection; const scale_const:boolean=True; const b:boolean=True);         {$region -fold}
var
  pvt0          : TPoint;
  ...
  begin
    if scale_const then
      ...
      begin
        with item_rct_default do
          item_rct_f          :=PtBoundsF(left,top,width,height);
        item_rct_prev_f       :=item_rct_f;
        item_rct              :=item_rct_default;
        scl_mul               :=1.0;
      end;
...
procedure   TUIImgScrollBox.OnMouseDown         (x,y:integer; button:TMouseButton=mbLeft);                                                                          {$region -fold}
var
  mousepos_: TPoint;
  dir      : TMovingDirection=mdUp;
begin
  if (button=mbMiddle) then
    begin
      ...
      mousepos_.x:=x;
      mousepos_.y:=y;
      SetPosShiftSize(mousepos_,dir,False,True);
    end
  else
    begin
      GetItemFocusedInd (x,y);
