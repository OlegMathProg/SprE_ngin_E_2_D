...
type
  ...
  TUIImgScrollBox =class(TUIObjManager) {$region -fold}
    public
      ...
      procedure   SetPosScrBarVDefault;                                           inline;
      procedure   SetPosScrBarHDefault;                                           inline;
      {Events}
      procedure   OnMouseLeave;                                                   inline;
      procedure   OnMouseMove         (      x,y              :integer;
                                             screen_cursor_ptr:PCursor);          inline;
      procedure   OnMouseDown         (      x,y              :integer);          inline;
      procedure   OnMouseUp           (      x,y              :integer);          inline;
      procedure   OnMouseWheel        (      shift_           :TShiftState;
                                             mousepos_        :TPoint;
                                       var   dir              :TMovingDirection); inline;
  end; {$endregion}
...
procedure   TUIImgScrollBox.SetPosScrBarVDefault;                                                                           inline; {$region -fold}
var
...
procedure   TUIImgScrollBox.SetPosScrBarHDefault;                                                                           inline; {$region -fold}
var
  slider_pos_min_max: TPtPos;
begin
  with scr_bar_v do
...
{Events}
procedure   TUIImgScrollBox.OnMouseLeave;                                                                                   inline; {$region -fold}
begin
...
procedure   TUIImgScrollBox.OnMouseMove         (x,y:integer; screen_cursor_ptr:PCursor);                                   inline; {$region -fold}
var
  slider_pos_min_max: TPtPos;
begin
  if (items_cnt=0) then
...
procedure   TUIImgScrollBox.OnMouseDown         (x,y:integer);                                                              inline; {$region -fold}
begin
  GetItemFocusedInd (x,y);
...
procedure   TUIImgScrollBox.OnMouseUp           (x,y:integer);                                                              inline; {$region -fold}
begin
 GetItemFocusedInd(x,y);
 SetItemsUnselected;
end; {$endregion}
procedure   TUIImgScrollBox.OnMouseWheel        (shift_:TShiftState; mousepos_:TPoint; var dir:TMovingDirection);           inline; {$region -fold}
begin
