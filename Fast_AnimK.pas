...
uses
  ...
  Classes, Math, Fast_Graphics{, SysUtils};
...
type
  ...
  {Brownian motion ************************************************************} {$region -fold}
  TBrVec     =record {$region -fold}
    collision_detect            : TProjectile;
    projectile_curr_pos         : TPtPosF;
    projectile_mov_vec          : TLnPosF;
    projectile_rnd              : integer;
    projectile_speed            : double;
    projectile_dir_tick_c_lim   : double;
    projectile_dir_tick_counter0: double;
    projectile_dir_tick_counter1: double;
    projectile_dir_tick_inc0    : double;
    projectile_dir_tick_inc1    : double;
    projectile_dir              : shortint;
    projectile_dir_switch       : boolean;
  end; {$endregion}
  PBrVec     =^TBrVec;
  {****************************************************************************} {$endregion}
  ...
  {Collision detection system *************************************************} {$region -fold}
  ...
  TFluid     =class {$region -fold}
    ...
    constructor Create      (      w,h          :integer);           {$ifdef Linux}[local];{$endif}
    destructor  Destroy;                                   override; {$ifdef Linux}[local];{$endif}
    procedure   WaveParamChg(var   param        :integer;
                                   val1,
                                   val2,
                                   val3         :integer); inline;   {$ifdef Linux}[local];{$endif}
    procedure   WaveParamChg(var   param        :double;
                                   val1,
                                   val2,
                                   val3         :double);  inline;   {$ifdef Linux}[local];{$endif}
    procedure   WaveInit1;                                           {$ifdef Linux}[local];{$endif}
    procedure   WaveInit2   (var   pts          :TPtPosFArr;
                             const start_ind,
                                   end_ind      :integer);           {$ifdef Linux}[local];{$endif}
    procedure   WaveInit3   (      pt_pos       :TPtPosF);           {$ifdef Linux}[local];{$endif}
    procedure   Wave1       (var   pts          :TPtPosFArr;
                             const start_ind,
                                   end_ind      :integer);           {$ifdef Linux}[local];{$endif}
    procedure   Wave2       (      pt_pos,
                                   shift        :TPtPosF;
                             const step_x,
                                   angle        :double;
                             const cnt          :integer;
                             ...
                             const first_pt_draw:boolean);           {$ifdef Linux}[local];{$endif}
    procedure   Wave3       (      pt_pos,
                                   shift        :TPtPosF;
                             const step_x,
                                   angle        :double;
                             const cnt          :integer;
                             ...
                             const rct_clp      :TPtRect;
                             const color_info   :TColorInfo;
                             const first_pt_draw:boolean;
                             const fade         :byte);              {$ifdef Linux}[local];{$endif}
    procedure   Wave4       (      sln_ind      :integer;
                             const step_x,
                                   angle        :double;
                             const cnt          :integer;
                             const bmp_dst_ptr  :PInteger;
                             const bmp_dst_width:TColor;
                             const rct_clp      :TPtRect;
                             const pix_col      :TColor;
                             const first_pt_draw:boolean=True;
                             const fade         :byte=MAXBYTE);      {$ifdef Linux}[local];{$endif}
  end; {$endregion}
  PFluid     =^TFluid;
  {****************************************************************************} {$endregion}
  ...
  function SetCollPt         (         x0,y0,x1,y1      :integer;
                              ...
                              constref val              :integer): TPtPos;    {$ifdef Linux}[local];{$endif}
  function SetCollPt         (         x0,y0,x1,y1      :integer;
                              constref bmp_dst_ptr      :PByte;
                              constref bmp_dst_width    :integer;
                              constref val              :byte   ): TPtPos;    {$ifdef Linux}[local];{$endif}
  // Get line segment index:
  procedure GetPtInd         (         x_coll,y_coll    :integer;
                              constref bmp_dst_ptr      :PInteger;
                              constref bmp_dst_width    :integer;
                              var      projectile_      :TProjectile);        {$ifdef Linux}[local];{$endif}
  // Get collision angle:
  function GetAngle          (constref x0,y0,x1,y1      :double;
                              constref projectile_      :TProjectile;
                              constref pts              :TPtPosFArr): double; {$ifdef Linux}[local];{$endif}
  {****************************************************************************} {$endregion}



  {Hair physics ***************************************************************} {$region -fold}
  {TODO}
  {****************************************************************************} {$endregion}



  {Fading effects *************************************************************} {$region -fold}
  ...
  procedure FXAnimPingPong   (var      fx_inc_check     :boolean;
                              ...
                              constref fx_min_val,
                                       fx_max_val       :double;
                              var      dir              :TMovingDirection); inline; {$ifdef Linux}[local];{$endif}
  procedure FXAnimPingPong   (var      fx_inc_check     :boolean;
                              constref fx_inc_val,
                                       fx_dec_val       :double;
                              var      fx               :double;
                              constref fx_min_val,
                                       fx_max_val       :double);           inline; {$ifdef Linux}[local];{$endif}
  {****************************************************************************} {$endregion}
  ...
  procedure GetNextPos       (var      projectile_      :TProjectile);      inline; {$ifdef Linux}[local];{$endif}
  procedure TimeChange       (var      projectile_      :TProjectile);      inline; {$ifdef Linux}[local];{$endif}
  procedure CRadChange       (var      projectile_      :TProjectile;
...
var
  ...
  br_vec_default    : TBrVec     ={$region -fold}
  (
    collision_detect            : {$region -fold}
      (
        {start position}
        pt_0         : (x:000; y:000);
        {previous position}
    ...
    projectile_curr_pos         : (x :400.0; y :400.0);
    projectile_mov_vec          : (x0:200.0; y0:200.0; x1:400.0; y1:400.0);
    projectile_rnd              : 1;
    projectile_speed            : 010.0;
    projectile_dir_tick_c_lim   : 128.0{255.0};
    projectile_dir_tick_counter0: 000.0;
    projectile_dir_tick_counter1: 000.0;
    projectile_dir_tick_inc0    : 006.0{002.0};
    projectile_dir_tick_inc1    : 006.0{002.0};
    projectile_dir              : 1;
    projectile_dir_switch       : False;
  ); {$endregion}
...
uses
  ...
  Fast_Scene_Tree, Fast_Main;

(******************************** Misc. routines ******************************) {$region -fold}

procedure UpdateTickCounter(var frame_skip:integer; frame_step:integer); {$region -fold}
begin
...
procedure GetNextPos(var projectile_:TProjectile                                            );          inline; {$ifdef Linux}[local];{$endif} {$region -fold}
var
  sin_,cos_: double;
begin
  with projectile_ do
...
procedure TimeChange(var projectile_:TProjectile                                            );          inline; {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  projectile_.time+=TIME_DELTA;
end; {$endregion}
procedure CRadChange(var projectile_:TProjectile; constref c_rad_delta:integer=1            );          inline; {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  projectile_.c_rad+=c_rad_delta;
end; {$endregion}
// Full projectile calc.:
...
{Screen space collision}
// Find collision point:
function SetCollPt(         x0,y0,x1,y1:integer; constref bmp_dst_ptr:PInteger; constref bmp_dst_width:integer; constref val:integer): TPtPos; {$ifdef Linux}[local];{$endif} {$region -fold}
var
  y0_shift                        : integer;
...
function SetCollPt(         x0,y0,x1,y1:integer; constref bmp_dst_ptr:PByte   ; constref bmp_dst_width:integer; constref val:byte   ): TPtPos; {$ifdef Linux}[local];{$endif} {$region -fold}
var
  y0_shift                        : integer;
  i,short_len,long_len,swp,dec_inc: integer;
  yLonger                         : boolean;
...
// Get line segment index:
procedure GetPtInd(x_coll,y_coll:integer; constref bmp_dst_ptr:PInteger; constref bmp_dst_width:integer; var projectile_:TProjectile);         {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  projectile_.pt_ind:=(bmp_dst_ptr+x_coll+y_coll*bmp_dst_width)^-1;
end; {$endregion}
// Get collision angle:
function GetAngle (constref x0,y0,x1,y1:double; constref projectile_:TProjectile; constref pts:TPtPosFArr): double;                            {$ifdef Linux}[local];{$endif} {$region -fold}
var
  pts_ptr: PPtPosF;
begin
...
procedure TFluid.WaveParamChg(var param:integer; val1,val2,val3:integer); inline;   {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  Dec(param, val1);
  if (param<=val2) then
      param:=val3;
end; {$endregion}
procedure TFluid.WaveParamChg(var param:double;  val1,val2,val3:double ); inline;   {$ifdef Linux}[local];{$endif} {$region -fold}
begin
      param-=val1;
  if (param<=val2) then
      param:=val3;
end; {$endregion}
procedure TFluid.WaveInit1;                                                         {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  a0:=256;
  a1:=128{064};
  a2:=128;
...
procedure TFluid.WaveInit2   (var pts:TPtPosFArr; const start_ind,end_ind:integer); {$ifdef Linux}[local];{$endif} {$region -fold}
begin
...
procedure TFluid.WaveInit3   (pt_pos :TPtPosF);                                     {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  r_x:=Trunc(pt_pos.x);
  r_y:=Trunc(pt_pos.y);
end; {$endregion}
procedure TFluid.Wave1       (var pts:TPtPosFArr; const start_ind,end_ind:integer); {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i: integer;
begin
...
procedure TFluid.Wave2       (pt_pos,shift:TPtPosF; const step_x,angle:double; const cnt:integer; const bmp_dst_ptr:PInteger; const bmp_dst_width:TColor; const rct_clp:TPtRect; const color_info:TColorInfo; const first_pt_draw:boolean                              ); {$ifdef Linux}[local];{$endif} {$region -fold}
var
  pt_inc   : TPtPosF;
  shift_int: TPtPos;
  a0_div_a1: double =2.0;
  c        : double =0.0;
  s        : double =0.0;
  v        : double =0.0;
  w        : double =0.0;
  i        : integer=000;
begin
  shift_int.x:=Round(shift.x);
  shift_int.y:=Round(shift.y);
  a0_div_a1  :=a0/a1;
  GetRot      (pt_pos,-angle,c,s,v,w);
  pt_inc     :=pt_pos;
  if first_pt_draw then
    begin
      PointC(Trunc(pt_pos.x)+Trunc(shift.x),
  ...
  for i:=1 to cnt-1 do
    begin
      pt_inc.x+=step_x;
      pt_inc.y:=a0_div_a1*exp((r_x-{+}pt_inc.x)/a2)*sin(a3+a4*(r_x-{+}pt_inc.x))+r_y;
      PointC(Round(-pt_inc.x*c+pt_inc.y*s+v)+shift_int.x,
             Round(-pt_inc.y*c-pt_inc.x*s+w)+shift_int.y,
             bmp_dst_ptr,
             bmp_dst_width,
             rct_clp,
             color_info);
...
procedure TFluid.Wave3       (pt_pos,shift:TPtPosF; const step_x,angle:double; const cnt:integer; const bmp_dst_ptr:PInteger; const bmp_dst_width:TColor; const rct_clp:TPtRect; const color_info:TColorInfo; const first_pt_draw:boolean;      const fade:byte        ); {$ifdef Linux}[local];{$endif} {$region -fold}
var
  pt_inc   : TPtPosF;
  shift_int: TPtPos;
  a0_div_a1: double =2.0;
...
procedure TFluid.Wave4       (sln_ind     :integer; const step_x,angle:double; const cnt:integer; const bmp_dst_ptr:PInteger; const bmp_dst_width:TColor; const rct_clp:TPtRect; const pix_col   :TColor;     const first_pt_draw:boolean=True; const fade:byte=MAXBYTE); {$ifdef Linux}[local];{$endif} {$region -fold}
var
...
begin
  with obj_var,sln_var do
    begin
      ...
      if (fade=0) then
        Exit;
      if (sln_ind>=sln_obj_cnt) then
        Exit;
      SetColorInfo2(pix_col,color_info);
      for i:=partial_pts_sum[sln_ind] to
             partial_pts_sum[sln_ind]+
             sln_obj_pts_cnt[sln_ind]-1 do
        begin
          WaveInit3(sln_pts[i]);
          Wave3    (sln_pts[i],
                    obj_arr[curve_inds_obj_arr[sln_ind]].world_axis_shift,
                    step_x,
                    angle,
                    cnt,
                    bmp_dst_ptr,
...
begin
  ...
  {for i:=0 to pt_cnt-1 do
    CircleHighlight003(pt_pos.x+Random(pos_shift_rad),
...
// Ping-pong(linear interpolation):
procedure FXAnimPingPong(var fx_inc_check:boolean; constref fx_inc_val,fx_dec_val:double; var fx:double; constref fx_min_val,fx_max_val:double; var dir:TMovingDirection); inline; {$ifdef Linux}[local];{$endif} {$region -fold}
begin
...
procedure FXAnimPingPong(var fx_inc_check:boolean; constref fx_inc_val,fx_dec_val:double; var fx:double; constref fx_min_val,fx_max_val:double                          ); inline; {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  if fx_inc_check then
    fx+=fx_inc_val
  else
