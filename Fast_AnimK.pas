...
procedure TFluid.WaveInit2   (var pts:TPtPosFArr; constref start_ind,end_ind:integer); {$ifdef Linux}[local];{$endif} {$region -fold}
begin
...
procedure TFluid.Wave1       (var pts:TPtPosFArr; constref start_ind,end_ind:integer); {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i: integer;
begin
...
procedure TFluid.Wave2       (pt_pos,shift:TPtPosF; constref step_x,angle:double; constref cnt:integer; constref bmp_dst_ptr:PInteger; constref bmp_dst_width:TColor; constref color_info:TColorInfo; constref rct_clp:TPtRect); {$ifdef Linux}[local];{$endif} {$region -fold}
var
  pt_inc  : TPtPosF;
  pt_rot  : TPtPosF;
  distance: double;
...
procedure TFluid.Wave3       (pt_pos,shift:TPtPosF; constref step_x,angle:double; constref cnt:integer; constref bmp_dst_ptr:PInteger; constref bmp_dst_width:TColor; constref color_info:TColorInfo; constref rct_clp:TPtRect); {$ifdef Linux}[local];{$endif} {$region -fold}
var
  pt_inc   : TPtPosF;
  pt_rot   : TPtPosF;
  distance : double;
...
procedure TFluid.Wave4       (sln_ind     :integer; constref step_x,angle:double; constref cnt:integer; constref bmp_dst_ptr:PInteger; constref bmp_dst_width:TColor; constref pix_col   :TColor;     constref rct_clp:TPtRect); {$ifdef Linux}[local];{$endif} {$region -fold}
var
