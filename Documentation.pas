...
var
  ...
  selit_doc_str_arr: TStringArr=
    (' CTRL+MMB ',
     ...
     ' Space ',
     '- switch selection mode;'+#13,
     ' RMB ',
     '(after selection) - align pivot on points;'+#13+' hold',
     ' SHIFT ',
     '(while moving mouse) - align pivot on axis Y;'+#13+' hold',
     ' CTRL ',
     '(while moving mouse) - align pivot on axis X');
...
begin
  ...
  SetLength(selit_doc_font_arr,10);
  ...
  selit_doc_font_arr[4]:=TFont.Create;
  selit_doc_font_arr[4]:=selit_doc_font_arr[0];

  selit_doc_font_arr[5]:=TFont.Create;
  selit_doc_font_arr[5]:=curve_doc_font_arr[1];

  selit_doc_font_arr[6]:=TFont.Create;
  selit_doc_font_arr[6]:=selit_doc_font_arr[0];

  selit_doc_font_arr[7]:=TFont.Create;
  selit_doc_font_arr[7]:=curve_doc_font_arr[1];

  selit_doc_font_arr[8]:=TFont.Create;
  selit_doc_font_arr[8]:=selit_doc_font_arr[0];

  selit_doc_font_arr[9]:=TFont.Create;
  selit_doc_font_arr[9]:=curve_doc_font_arr[1];
