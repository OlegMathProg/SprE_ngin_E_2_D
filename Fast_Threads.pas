...
procedure PPGrVAlphaBlendMT   (const bmp_dst_ptr   :PInteger;
                               ...
                               const col0,col1     :TColor;
                               const block_count   :integer=1);
procedure PPGrVAlphaBlend128MT(const bmp_dst_ptr   :PInteger;
                               const bmp_dst_width :TColor;
                               const rct_dst_      :TPtRect;
                               const col0,col1     :TColor;
                               const block_count   :integer=1);
procedure PPGrVAlphaBlend256MT(const bmp_dst_ptr   :PInteger;
                               const bmp_dst_width :TColor;
                               const rct_dst_      :TPtRect;
                               const col0,col1     :TColor;
                               const block_count   :integer=1);
...
begin
  ...
  ProcThreadPool.DoParallel(@PPAlphaBlend128ST,0,block_count-1,@func_data);
end; {$endregion}
} {$endregion}
procedure PPAlphaBlend128MT   (const bmp_dst_ptr:PInteger; const bmp_dst_width:TColor; const rct_dst_:TPtRect; const col:TColor;                    const pow:byte=64; const block_count:integer=1); {$region -fold}
  ...
  begin
    PPAlphaBlend128A(bmp_dst_ptr,bmp_dst_width,SetRct(index,rct_dst_,block_count),col,pow);
  end; {$endregion}
...
procedure PPAlphaBlend256MT   (const bmp_dst_ptr:PInteger; const bmp_dst_width:TColor; const rct_dst_:TPtRect; const col:TColor;                    const pow:byte=64; const block_count:integer=1); {$region -fold}
  ...
  procedure PPAlphaBlendMTParallel(index:PtrInt; data:pointer; item:TMultiThreadProcItem); {$region -fold}
  begin
    PPAlphaBlend256A(bmp_dst_ptr,bmp_dst_width,SetRct(index,rct_dst_,block_count),col,pow);
  end; {$endregion}
...
procedure PPGrVAlphaBlend128MT(const bmp_dst_ptr:PInteger; const bmp_dst_width:TColor; const rct_dst_:TPtRect; const col0,col1:TColor;                                 const block_count:integer=1); {$region -fold}
  ...
  begin
    GrVPrecalc        (index,block_rct1,rct_dst_,col0,col1,block_count);
    PPGrVAlphablend128(bmp_dst_ptr,bmp_dst_width,block_rct1,fast_image_proc_var.fast_image_data_arr[index].grad_prop,bmp_dst_width);
  end; {$endregion}

begin
  ProcThreadPool.DoParallelLocalProc(@PPGrVAlphaBlendMTParallel,0,block_count-1);
end; {$endregion}
procedure PPGrVAlphaBlend256MT(const bmp_dst_ptr:PInteger; const bmp_dst_width:TColor; const rct_dst_:TPtRect; const col0,col1:TColor;                                 const block_count:integer=1); {$region -fold}
  ...
  begin
    GrVPrecalc        (index,block_rct1,rct_dst_,col0,col1,block_count);
    PPGrVAlphablend256(bmp_dst_ptr,bmp_dst_width,block_rct1,fast_image_proc_var.fast_image_data_arr[index].grad_prop,bmp_dst_width);
  end; {$endregion}
