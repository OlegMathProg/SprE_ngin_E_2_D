...
procedure PPAdditiveDecMT  (const bmp_dst_ptr:PInteger; const bmp_dst_width:TColor; const rct_dst:TPtRect; const col:TColor;                    const pow:byte=64; const block_count:integer=1); {$region -fold}
...
procedure PPInverseDecMT   (const bmp_dst_ptr:PInteger; const bmp_dst_width:TColor; const rct_dst:TPtRect;                                      const pow:byte=64; const block_count:integer=1); {$region -fold}
...
procedure PPGrayscaleRDecMT(const bmp_dst_ptr:PInteger; const bmp_dst_width:TColor; const rct_dst:TPtRect;                                      const pow:byte=64; const block_count:integer=1); {$region -fold}
...
procedure PPGrayscaleGDecMT(const bmp_dst_ptr:PInteger; const bmp_dst_width:TColor; const rct_dst:TPtRect;                                      const pow:byte=64; const block_count:integer=1); {$region -fold}
...
procedure PPGrayscaleBDecMT(const bmp_dst_ptr:PInteger; const bmp_dst_width:TColor; const rct_dst:TPtRect;                                      const pow:byte=64; const block_count:integer=1); {$region -fold}
...
procedure PPMonoNoiseDecMT (const bmp_dst_ptr:PInteger; const bmp_dst_width:TColor; const rct_dst:TPtRect; const col:TColor;                    const pow:byte=64; const block_count:integer=1); {$region -fold}
...
// MT RandNoise:
procedure PPRandNoiseMT    (const bmp_dst_ptr:PInteger; const bmp_dst_width:TColor; const rct_dst:TPtRect; const proc_ind:byte; pow1,pow2:byte;                    const block_count:integer=1); {$region -fold}

  procedure PPRandNoiseMTParallel(index:PtrInt; data:pointer; item:TMultiThreadProcItem); {$region -fold}
  begin
    PPRandNoise(bmp_dst_ptr,bmp_dst_width,SetRct(index,rct_dst,block_count),proc_ind,pow1,pow2);
  end; {$endregion}

begin
  ProcThreadPool.DoParallelLocalProc(@PPRandNoiseMTParallel,0,block_count-1);
end; {$endregion}
procedure PPRandNoiseDecMT (const bmp_dst_ptr:PInteger; const bmp_dst_width:TColor; const rct_dst:TPtRect; const proc_ind:byte; pow1,pow2:byte; const pow:byte=64; const block_count:integer=1); {$region -fold}

  procedure PPRandNoiseDecMTParallel(index:PtrInt; data:pointer; item:TMultiThreadProcItem); {$region -fold}
  begin
    PPRandNoiseDec(bmp_dst_ptr,bmp_dst_width,SetRct(index,rct_dst,block_count),proc_ind,pow1,pow2,pow);
  end; {$endregion}
...
// MT Blur:
procedure PPBlur4MT        (const bmp_dst_ptr:PInteger; const bmp_dst_width:TColor; const rct_dst:TPtRect; const PPBlur4Proc:TProc8;                               const block_count:integer=1); {$region -fold}

  procedure PPBlur4MTParallel(index:PtrInt; data:pointer; item:TMultiThreadProcItem); {$region -fold}
  begin
    {
    {Debug}
    PPFloodFill(bmp_dst_ptr,bmp_dst_width,SetRct(index,rct_dst,block_count),RGB(Random(100),Random(100),Random(100)));
    }
    PPBlur4(bmp_dst_ptr,bmp_dst_width,SetRct(index,rct_dst,block_count),PPBlur4Proc);
  end; {$endregion}

begin
  ProcThreadPool.DoParallelLocalProc(@PPBlur4MTParallel,0,block_count-1);
end; {$endregion}
procedure PPBlur4DecMT     (const bmp_dst_ptr:PInteger; const bmp_dst_width:TColor; const rct_dst:TPtRect; const PPBlur4Proc:TProc19;           const pow:byte=64; const block_count:integer=1); {$region -fold}

  procedure PPBlur4DecMTParallel(index:PtrInt; data:pointer; item:TMultiThreadProcItem); {$region -fold}
  begin
    {
    {Debug}
    PPFloodFill(bmp_dst_ptr,bmp_dst_width,SetRct(index,rct_dst,block_count),RGB(62*index,62*index,62*index));
    }
    PPBlur4Dec(bmp_dst_ptr,bmp_dst_width,SetRct(index,rct_dst,block_count),PPBlur4Proc,pow);
  end; {$endregion}
...
// MT Contrast:
procedure PPContrastMT     (const bmp_dst_ptr:PInteger; const bmp_dst_width:TColor; const rct_dst:TPtRect;                                      const pow:byte=64; const block_count:integer=1); {$region -fold}

  procedure PPContrastMTParallel(index:PtrInt; data:pointer; item:TMultiThreadProcItem); {$region -fold}
  begin
    PPContrast1(bmp_dst_ptr,bmp_dst_width,SetRct(index,rct_dst,block_count),pow);
  end; {$endregion}
...
// MT Gamma:
procedure PPGammaMT        (const bmp_dst_ptr:PInteger; const bmp_dst_width:TColor; const rct_dst:TPtRect; const pow0:single;                                      const block_count:integer=1); {$region -fold}

    procedure PPGammaMTParallel(index:PtrInt; data:pointer; item:TMultiThreadProcItem); {$region -fold}
    begin
      PPGamma(bmp_dst_ptr,bmp_dst_width,SetRct(index,rct_dst,block_count),pow0);
    end; {$endregion}

begin
  ProcThreadPool.DoParallelLocalProc(@PPGammaMTParallel,0,block_count-1);
end; {$endregion}
procedure PPGammaDecMT     (const bmp_dst_ptr:PInteger; const bmp_dst_width:TColor; const rct_dst:TPtRect; const pow0:single;                   const pow:byte=64; const block_count:integer=1); {$region -fold}

  procedure PPGammaDecMTParallel(index:PtrInt; data:pointer; item:TMultiThreadProcItem); {$region -fold}
  begin
    PPGammaDec(bmp_dst_ptr,bmp_dst_width,SetRct(index,rct_dst,block_count),pow0,pow);
  end; {$endregion}
