...
// AlphaBlend:
procedure PPAlphaBlendMT   (const bmp_dst_ptr:PInteger; const bmp_dst_width:TColor; const rct_dst_:TPtRect; const col:TColor;                    const pow:byte=64; const block_count:integer=1); {$region -fold}

  procedure PPAlphaBlendMTParallel(index:PtrInt; data:pointer; item:TMultiThreadProcItem); {$region -fold}
  begin
    PPAlphaBlend(bmp_dst_ptr,bmp_dst_width,SetRct(index,rct_dst_,block_count),col,pow);
  end; {$endregion}
