...
type
  ...
  TSceneTree      =class         {$region -fold}
    public
      ...
      procedure   FilPProc;                                                           inline;   {$ifdef Linux}[local];{$endif}
      ...
      procedure   MovPProc;                                                           inline;   {$ifdef Linux}[local];{$endif}
     ...
     {procedure   MovSceneMT             (      rct_dst          :TPtRect;
      ...
      procedure   AddObjTag              (      node_with_data   :TTreeNode;
                                          const koot             :TKindOfObjectTag);  inline;   {$ifdef Linux}[local];{$endif}
      ...
      {in editor}
      procedure   VisObjArrCrt0                                                       inline;   {$ifdef Linux}[local];{$endif}
      {in game}
      procedure   VisObjArrCrt1                                                       inline;   {$ifdef Linux}[local];{$endif}
      {in editor or game}
      procedure   VisObjArrCrt2                                                       inline;   {$ifdef Linux}[local];{$endif}
...
procedure   TSceneTree.FilPProc;                                                                                                                                                                       inline; {$ifdef Linux}[local];{$endif} {$region -fold}
var
...
procedure   TSceneTree.MovPProc;                                                                                                                                                                       inline; {$ifdef Linux}[local];{$endif} {$region -fold}
var
  ppr_var_inst_ptr: PPProc=Nil;
begin
  ppr_var_inst_ptr:=@ppr_var;
...
procedure   TSceneTree.AddObjTag             (node_with_data:TTreeNode; const koot:TKindOfObjectTag);                                                                                                  inline; {$ifdef Linux}[local];{$endif} {$region -fold}
var
...
procedure   TSceneTree.SetObjBkgnd           (obj_arr_ptr:PObjProp; const bkgnd_ptr0,bkgnd_ptr1:PInteger; const bkgnd_width,bkgnd_height:TColor; const rct_clp_ptr:PPtRect);                           inline; {$ifdef Linux}[local];{$endif} {$region -fold}
begin
...
procedure   TSceneTree.SetObjBkgnd           (                      const bkgnd_ptr0,bkgnd_ptr1:PInteger; const bkgnd_width,bkgnd_height:TColor; const rct_clp_ptr:PPtRect; start_ind,end_ind:TColor); inline; {$ifdef Linux}[local];{$endif} {$region -fold}
var
  obj_arr_ptr     : PObjProp;
  obj_inds_arr_ptr: PColor;
  i               : integer;
...
// (Create array of indices of visible(in editor/in game) objects) Создать массив индексов видимых(в редакторе/в игре) обьектов:
{In editor}
procedure   TSceneTree.VisObjArrCrt0;                                                                                                                                                                  inline; {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i: integer;
begin
  if (obj_cnt=0) then
...
{In game}
procedure   TSceneTree.VisObjArrCrt1;                                                                                                                                                                  inline; {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i: integer;
begin
  if (obj_cnt=0) then
...
{In editor or game}
procedure   TSceneTree.VisObjArrCrt2;                                                                                                                                                                  inline; {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i             : integer;
  editor_or_game: set of byte;
begin
