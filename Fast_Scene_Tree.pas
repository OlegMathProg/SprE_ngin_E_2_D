...
uses
  ...
  Classes, Fast_Graphics, TypInfo, ComCtrls, SysUtils;
...
type
  ...
  TKindOfObjectTag       =(kootMaterial,
                           ...
                           kootTilemap,
                           kootMiscellaneous);
  PKindOfObjectTag       =^TKindOfObjectTag;

  TImgData               =packed record {$region -fold}
    ...
    // 0: regular;
    // 1: gamma_corrected;
    id_gamma_correction: byte;
    {Type of sprite inversion along axes}
    // [0..003]
    // 0 - not     inverted;
    // 1 - x -axis inverted;
    // 2 - y -axis inverted;
    // 3 - xy-axis inverted;
    id_img_inv_type    : byte;
  end; {$endregion}
  PImgData               =^TImgData;

  {Tag "Material" consists of layers:
  each layer is array of sprite indices(TColorArr        ) and
                array of sprite data   (array of TImgData)}
  TMaterialTagData       =packed record {$region -fold}
    // Indices of sprites inside "Content library(Images)""
    sprite_inds_arr: array of TColorArr;
    // Image layers:
    img_layers_arr : array of array of TImgData;
  end; {$endregion}
  PMaterialTagData       =^TMaterialTagData;

  TMarkerTagData         =packed record {$region -fold}
    // ...
  end; {$endregion}
  PMarkerTagData         =^TMarkerTagData;

  TPointsSelectionTagData=packed record {$region -fold}
    // ...
  end; {$endregion}
  PPointsSelectionTagData=^TPointsSelectionTagData;

  TAnimationTagData      =packed record {$region -fold}
    // ...
  end; {$endregion}
  PAnimationTagData      =^TAnimationTagData;

  TSpecialEffectTagData  =packed record {$region -fold}
    // ...
  end; {$endregion}
  PSpecialEffectTagData  =^TSpecialEffectTagData;

  TTriggerTagData        =packed record {$region -fold}
    // ...
  end; {$endregion}
  PTriggerTagData        =^TTriggerTagData;

  TCameraTagData         =packed record {$region -fold}
    // ...
  end; {$endregion}
  PCameraTagData         =^TCameraTagData;

  TTextTagData           =packed record {$region -fold}
    // ...
  end; {$endregion}
  PTextTagData           =^TTextTagData;

  TTilemapTagData        =packed record {$region -fold}
    // ...
  end; {$endregion}
  PTilemapTagData        =^TTilemapTagData;

  TObjectTag             =packed record {$region -fold}
    obj_tag_data_ptr: pointer;
    // Tag name:
    name            : AnsiString;
    // Kind of object tag:
    koot            : TKindOfObjectTag;
    // Is tag selected:
    is_selected     : boolean;
    // Is tag focused:
    is_focused      : boolean;
  end; {$endregion}
  PObjectTag             =^TObjectTag;
  ...
  TSceneTree             =class         {$region -fold}
    public
      ...
      // Array of objects indices inside object array:
      obj_inds_arr                  : TColorArr;
      // Array of selected objects indices inside scene tree:
      sel_inds_arr                  : TColorArr;
      // Array of indices of objects which are not selected and have "Group" node as parent inside scene tree:
      gr_not_sel_chld_inds_arr      : TColorArr;
      // Array of indices of visible objects:
      {In editor}
      vis_inds_arr0                 : TColorArr;
      {Count of visible items in editor}
      vis_inds_cnt0                 : TColor;
      {In game}
      vis_inds_arr1                 : TColorArr;
      {Count of visible items in game}
      vis_inds_cnt1                 : TColor;
      {In editor/game}
      vis_inds_arr2                 : TColorArr;
      {Count of visible items in editor/game}
      vis_inds_cnt2                 : TColor;
      {Object tags}
      obj_tags_cnt                  : array of integer;
      obj_tags_arr                  : array of array of TObjectTag;
      sel_obj_tags_arr              : array of PBoolean;
      sel_obj_tags_cnt              : TColor;
      focused_tag_ind_x             : integer;
      focused_tag_ind_y             : integer;

      {Array of object tags data-----------} {$region -fold}
      material_tags_data_arr        : array of TMaterialTagData;
      marker_tags_data_arr          : array of TMarkerTagData;
      points_selection_tags_data_arr: array of TPointsSelectionTagData;
      animation_tags_data_arr       : array of TAnimationTagData;
      special_effect_tags_data_arr  : array of TSpecialEffectTagData;
      trigger_tags_data_arr         : array of TTriggerTagData;
      camera_tags_data_arr          : array of TCameraTagData;
      text_tags_data_arr            : array of TTextTagData;
      tilemap_tags_data_arr         : array of TTilemapTagData; {$endregion}

      {Array of indices inside object array} {$region -fold}
      ...
      pproc_inds_obj_arr            : TColorArr;
      curve_inds_obj_arr            : TColorArr;
      ftext_inds_obj_arr            : TColorArr; {$endregion}

      {Array of indices inside scene tree--} {$region -fold}
      ...
      curr_obj_ind                  : TColor;
      // Index of first selected node in the scene tree:
      first_sel_node_ind            : TColor;
      // Index of last selected node in the scene tree:
      last_sel_node_ind             : TColor;
      // Count of     all      objects                                   in the scene:
      obj_cnt                       : TColor;
      // Count of     selected objects                                   in the scene:
      sel_cnt                       : TColor;
      // Count of not selected objects which have "Group" node as parent in the scene:
      gr_not_sel_chld_cnt           : TColor;
      // Lower layer objects count:
      low_lr_obj_cnt                : TColor;
      // Upper layer objects count:
      upp_lr_obj_cnt                : TColor;
      // Count of visible nodes:
      visible_nodes_cnt             : TColor;
      // Kind of selected objects:
      sel_koo                       : TKindOfObject;
      //
      add_object                    : boolean;
      // Is an item with children in the scene tree:
      has_it_with_ch                : boolean;
      // Count of layers with blur effect:
      blur_layers_cnt               : TColor;
      // Does some layer have blur effect:
      has_blur                      : boolean;
      ...
      // Count of selected objects of "Post-Process":
      pproc_selected                : boolean;
      // Count of selected objects of "Splines"("Curves"):
      curve_selected                : boolean;
      // Count of selected objects of "Text Fields":
      ...
      procedure   FilBkgnd;                                                                     {$ifdef Linux}[local];{$endif}
      procedure   FilRGrid;                                                                     {$ifdef Linux}[local];{$endif}
      procedure   FilSGrid;                                                                     {$ifdef Linux}[local];{$endif}
      procedure   FilGroup;                                                                     {$ifdef Linux}[local];{$endif}
      procedure   FilTlMap;                                                                     {$ifdef Linux}[local];{$endif}
      procedure   FilActor;                                                                     {$ifdef Linux}[local];{$endif}
      procedure   FilPProc;                                                                     {$ifdef Linux}[local];{$endif}
      procedure   FilCurve;                                                                     {$ifdef Linux}[local];{$endif}
      procedure   FilFText;                                                                     {$ifdef Linux}[local];{$endif}
      procedure   FilScene               (      start_ind,
                                                end_ind          :TColor);                      {$ifdef Linux}[local];{$endif}
      procedure   MovBkgnd;                                                                     {$ifdef Linux}[local];{$endif}
      procedure   MovRGrid;                                                                     {$ifdef Linux}[local];{$endif}
      procedure   MovSGrid;                                                                     {$ifdef Linux}[local];{$endif}
      procedure   MovGroup;                                                                     {$ifdef Linux}[local];{$endif}
      procedure   MovTlMap;                                                                     {$ifdef Linux}[local];{$endif}
      procedure   MovActor;                                                                     {$ifdef Linux}[local];{$endif}
      procedure   MovPProc;                                                                     {$ifdef Linux}[local];{$endif}
      procedure   MovCurve;                                                                     {$ifdef Linux}[local];{$endif}
      procedure   MovFText;                                                                     {$ifdef Linux}[local];{$endif}
      procedure   MovScene               (      start_ind,
                                                end_ind          :TColor);                      {$ifdef Linux}[local];{$endif}
     {procedure   MovSceneMT             (      rct_dst          :TPtRect;
                                                start_ind,
                                                end_ind          :TColor;
                                                block_count      :integer=1);         virtual;
                                                                                      abstract;}
      procedure   MovWorldAxisShiftRight;                                                       {$ifdef Linux}[local];{$endif}
      procedure   MovWorldAxisShiftRight2;                                                      {$ifdef Linux}[local];{$endif}
      procedure   MovWorldAxisShiftLeft;                                                        {$ifdef Linux}[local];{$endif}
      procedure   MovWorldAxisShiftLeft2;                                                       {$ifdef Linux}[local];{$endif}
      procedure   MovWorldAxisShiftDown;                                                        {$ifdef Linux}[local];{$endif}
      procedure   MovWorldAxisShiftDown2;                                                       {$ifdef Linux}[local];{$endif}
      procedure   MovWorldAxisShiftUp;                                                          {$ifdef Linux}[local];{$endif}
      procedure   MovWorldAxisShiftUp2;                                                         {$ifdef Linux}[local];{$endif}
      procedure   SetWorldAxisShift      (      world_axis_shift_:TPtPosF);                     {$ifdef Linux}[local];{$endif}
      ...
      procedure   SetFilMovProc          (      abstract_        :boolean;
                                          ...
                                          var   obj_cnt_         :TColor;
                                          var   inds_obj_arr_,
                                                inds_sct_arr_    :TColorArr);                   {$ifdef Linux}[local];{$endif}
      procedure   Add                    (const koo              :TKindOfObject;
                                          const world_axis_shift_:TPtPosF);                     {$ifdef Linux}[local];{$endif}
      procedure   AddObjTag              (      node_with_data   :TTreeNode;
                                          const koot_            :TKindOfObjectTag);            {$ifdef Linux}[local];{$endif}
      procedure   SetObjBkgnd            (      obj_arr_ptr      :PObjProp;
                                          const bkgnd_ptr0,
                                                bkgnd_ptr1       :PInteger;
                                          const bkgnd_width,
                                                bkgnd_height     :TColor;
                                          const rct_clp_ptr      :PPtRect);                     {$ifdef Linux}[local];{$endif}
      procedure   SetObjBkgnd            (const bkgnd_ptr0,
                                                bkgnd_ptr1       :PInteger;
                                          const bkgnd_width,
                                                bkgnd_height     :TColor;
      ...
      procedure   CrtNodeData            (      node_with_data   :TTreeNode;
                                                g_ind            :TColor);                      {$ifdef Linux}[local];{$endif}
      // Clear  node data:
      procedure   ClrNodeData            (      node_with_data   :TTreeNode);                   {$ifdef Linux}[local];{$endif}
      // Write data: proc. table:
      procedure   WrtNodeDataProcArrInit;                                                       {$ifdef Linux}[local];{$endif}
      // Byte:
      procedure   WrtNodeDataProc00      (const data_write;
                                                data_shift       :integer;
                                                data_ptr0        :pointer);                     {$ifdef Linux}[local];{$endif}
      procedure   WrtNodeDataProc01      (const data_write;
                                                data_shift       :integer;
                                                data_ptr0,
                                                data_ptr1        :pointer);                     {$ifdef Linux}[local];{$endif}
      // Bitpacked Byte:
      ...
      procedure   WrtNodeData            (const data_write;
                                                data_shift       :integer;
                                                proc0            :TProc21;
                                                proc1            :TProc22);                     {$ifdef Linux}[local];{$endif}
      // (Create array of indices of visible(in editor/in game) objects) Создать массив индексов видимых(в редакторе/в игре) обьектов:
      {in editor}
      procedure   VisObjArrCrt0;                                                                {$ifdef Linux}[local];{$endif}
      {in game}
      procedure   VisObjArrCrt1;                                                                {$ifdef Linux}[local];{$endif}
      {in editor or game}
      procedure   VisObjArrCrt2;                                                                {$ifdef Linux}[local];{$endif}
      ...
      function    IsAnotherObjKindAfter1 (const koo              :TKindOfObject;
                                          const start_ind        :TColor=0): boolean;           {$ifdef Linux}[local];{$endif}
      function    IsAnotherObjKindAfter2 (const start_ind        :TColor=0): boolean;           {$ifdef Linux}[local];{$endif}
      ...
      function    LowLrObjCntCalc1: TColor;                                                     {$ifdef Linux}[local];{$endif}
      procedure   LowLrObjCntCalc2;                                                             {$ifdef Linux}[local];{$endif}
      ...
      // TODO:
      function    TIndMin                (const obj_inds_arr_    :TColorArr;
                                          const arr              :TEdgeArr;
                                          const max_item_val     :TColor;
                                          const item_cnt         :TColor): TColor;              {$ifdef Linux}[local];{$endif}
      function    TIndMin                (const obj_inds_arr_    :TColorArr;
                                          const arr              :TSlPtArr;
                                          const max_item_val     :TColor;
                                          const item_cnt         :TColor): TColor;              {$ifdef Linux}[local];{$endif}
      ...
      function    PtsRngIndsRctCalc      (const pts              :TPtPosFArr;
                                          ...
                                          const pts_cnt          :TColor): TPtRectF;            {$ifdef Linux}[local];{$endif}
  end; {$endregion}
  ...
  TNodeData              =packed record {$region -fold}
    ...
    g_ind      : TColor;
    // Chess order state of tree node:
    chess_state: boolean;
  ...
  TRecInfo               =class  {$region -fold}
    ...
    procedure Assign (const rec_info         :PTypeInfo;
                      const bitp_fld_arr     :T1Byte1Arr);
    // Each next element of mask_val corresponds to each next eight fields in the record in little endian order:
    procedure MaskTo (const mask_val         :T1Byte1Arr);
    // Fill array cmp_it_arr with specified value "val":
    procedure CmpFil (const val              :byte=1);
    // Compares the fields of each of the elements of the array of records and stores in the array cmp_it_arr the index of the first record with a field that has the different value:
    ...
    procedure CmpRec1(const rec_ptr          :pointer;
                      ...
                      const first_sel_node   :TTreeNode);
...
begin
  SetLength(obj_tags_cnt,specialize GetEnumSize<TKindOfObjectTag>);
...
procedure   TSceneTree.FilBkgnd;                                                                                                                                                                               {$ifdef Linux}[local];{$endif} {$region -fold}
var
...
procedure   TSceneTree.FilRGrid;                                                                                                                                                                               {$ifdef Linux}[local];{$endif} {$region -fold}
var
...
procedure   TSceneTree.FilSGrid;                                                                                                                                                                               {$ifdef Linux}[local];{$endif} {$region -fold}
var
...
procedure   TSceneTree.FilGroup;                                                                                                                                                                               {$ifdef Linux}[local];{$endif} {$region -fold}
begin
end; {$endregion}
procedure   TSceneTree.FilTlMap;                                                                                                                                                                               {$ifdef Linux}[local];{$endif} {$region -fold}
var
...
procedure   TSceneTree.FilActor;                                                                                                                                                                               {$ifdef Linux}[local];{$endif} {$region -fold}
begin

end; {$endregion}
procedure   TSceneTree.FilPProc;                                                                                                                                                                               {$ifdef Linux}[local];{$endif} {$region -fold}
var
  ppr_var_inst_ptr: PPProc=Nil;
begin
  ppr_var_inst_ptr:=@ppr_var;
  ppr_var_inst_ptr^.FilPProcObj(curr_obj_ind);
end; {$endregion}
procedure   TSceneTree.FilFText;                                                                                                                                                                               {$ifdef Linux}[local];{$endif} {$region -fold}
var
  txt_var_inst_ptr: PFText=Nil;
begin
  txt_var_inst_ptr:=@txt_var;
  txt_var_inst_ptr^.FilFTextObj(curr_obj_ind);
end; {$endregion}
procedure   TSceneTree.FilCurve;                                                                                                                                                                               {$ifdef Linux}[local];{$endif} {$region -fold}
var
...
begin
  ...
  for i:=start_ind to end_ind do
    if              ((obj_arr[obj_inds_arr[i]].obj_show and %00000011) in editor_or_game) then
      begin
        curr_obj_ind:=obj_arr[obj_inds_arr[i]].k_ind;
        FilProc              [obj_inds_arr[i]];
      end;}

  start_ind0:=BinarySearch3(vis_inds_cnt2,@vis_inds_arr2[0],start_ind);
  end_ind0  :=BinarySearch3(vis_inds_cnt2,@vis_inds_arr2[0],end_ind);
  if (vis_inds_arr2[start_ind0]<>start_ind) and (start_ind0<>0) then
    Inc(start_ind0);
  for i:=start_ind0 to end_ind0 do
    begin
      curr_obj_ind:=obj_arr[obj_inds_arr[vis_inds_arr2[i]]].k_ind;
      FilProc              [obj_inds_arr[vis_inds_arr2[i]]];
    end;
  ...
  F_MainForm.M_Test_Log.Lines.Add('start_ind0='+IntToStr(start_ind0)+'; '+'end_ind0='+IntToStr(end_ind0));
  for i:=start_ind0 to end_ind0 do
    F_MainForm.M_Test_Log.Lines.Add(IntToStr(obj_arr[obj_inds_arr[vis_inds_arr2[i]]].k_ind)+'; '+IntToStr(obj_inds_arr[vis_inds_arr2[i]]));

  F_MainForm.M_Test_Log.Lines.Add(#13);

  F_MainForm.M_Test_Log.Lines.Add('start_ind='+IntToStr(start_ind)+'; '+'end_ind='+IntToStr(end_ind));
  for i:=start_ind to end_ind do
    if ((obj_arr[obj_inds_arr[i]].obj_show and %00000011) in editor_or_game) then
      F_MainForm.M_Test_Log.Lines.Add(IntToStr(obj_arr[obj_inds_arr[i]].k_ind)+';'+IntToStr(obj_inds_arr[i]));}

end; {$endregion}
procedure   TSceneTree.MovBkgnd;                                                                                                                                                                               {$ifdef Linux}[local];{$endif} {$region -fold}
var
  srf_var_inst_ptr: PSurface=Nil;
begin
  srf_var_inst_ptr:=@srf_var;
...
procedure   TSceneTree.MovRGrid;                                                                                                                                                                               {$ifdef Linux}[local];{$endif} {$region -fold}
var
  rgr_var_inst_ptr: PRGrid=Nil;
begin
...
procedure   TSceneTree.MovSGrid;                                                                                                                                                                               {$ifdef Linux}[local];{$endif} {$region -fold}
var
  sgr_var_inst_ptr: PSGrid=Nil;
begin
...
procedure   TSceneTree.MovGroup;                                                                                                                                                                               {$ifdef Linux}[local];{$endif} {$region -fold}
begin

end; {$endregion}
procedure   TSceneTree.MovTlMap;                                                                                                                                                                               {$ifdef Linux}[local];{$endif} {$region -fold}
var
  tlm_var_inst_ptr: PTlMap=Nil;
begin
  tlm_var_inst_ptr:=Unaligned(@tlm_var);
...
procedure   TSceneTree.MovActor;                                                                                                                                                                               {$ifdef Linux}[local];{$endif} {$region -fold}
begin

end; {$endregion}
procedure   TSceneTree.MovPProc;                                                                                                                                                                               {$ifdef Linux}[local];{$endif} {$region -fold}
var
  ppr_var_inst_ptr: PPProc=Nil;
begin
  ppr_var_inst_ptr:=@ppr_var;
  ppr_var_inst_ptr^.MovPProcObj(curr_obj_ind);
end; {$endregion}
procedure   TSceneTree.MovFText;                                                                                                                                                                               {$ifdef Linux}[local];{$endif} {$region -fold}
var
  txt_var_inst_ptr: PFText=Nil;
begin
  txt_var_inst_ptr:=@txt_var;
  txt_var_inst_ptr^.MovFTextObj(curr_obj_ind);
end; {$endregion}
procedure   TSceneTree.MovCurve;                                                                                                                                                                               {$ifdef Linux}[local];{$endif} {$region -fold}
var
  sln_var_inst_ptr: PCurve=Nil;
begin
  sln_var_inst_ptr:=Unaligned(@sln_var);
...
procedure   TSceneTree.MovScene              (start_ind,end_ind:TColor);                                                                                                                                       {$ifdef Linux}[local];{$endif} {$region -fold}
var
  editor_or_game     : set of byte;
  start_ind0,end_ind0: integer;
  i                  : integer;
begin
  ...
  for i:=start_ind0 to end_ind0 do
    begin
      curr_obj_ind:=obj_arr[obj_inds_arr[vis_inds_arr2[i]]].k_ind;
      MovProc              [obj_inds_arr[vis_inds_arr2[i]]];
    end;

end; {$endregion}
procedure   TSceneTree.MovWorldAxisShiftRight;                                                                                                                                                                 {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i: integer;
begin
  if (obj_cnt=0) then
...
procedure   TSceneTree.MovWorldAxisShiftRight2;                                                                                                                                                                {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i: integer;
begin
  if (obj_cnt=0) then
...
procedure   TSceneTree.MovWorldAxisShiftLeft;                                                                                                                                                                  {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i: integer;
begin
  if (obj_cnt=0) then
...
procedure   TSceneTree.MovWorldAxisShiftLeft2;                                                                                                                                                                 {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i: integer;
begin
  if (obj_cnt=0) then
...
procedure   TSceneTree.MovWorldAxisShiftDown;                                                                                                                                                                  {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i: integer;
begin
  if (obj_cnt=0) then
...
procedure   TSceneTree.MovWorldAxisShiftDown2;                                                                                                                                                                 {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i: integer;
begin
  if (obj_cnt=0) then
...
procedure   TSceneTree.MovWorldAxisShiftUp;                                                                                                                                                                    {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i: integer;
begin
  if (obj_cnt=0) then
...
procedure   TSceneTree.MovWorldAxisShiftUp2;                                                                                                                                                                   {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i: integer;
begin
  if (obj_cnt=0) then
...
procedure   TSceneTree.SetWorldAxisShift     (world_axis_shift_:TPtPosF);                                                                                                                                      {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i: integer;
begin
  if (obj_cnt=0) then
...
procedure   TSceneTree.SetRctDstPtr          (rct_dst_ptr_:PPtRect; start_ind,end_ind:TColor);                                                                                                                 {$ifdef Linux}[local];{$endif} {$region -fold}
var
...
procedure   TSceneTree.SetFilMovProc         (abstract_:boolean; FilProc_,MovProc_:TProc0; var obj_cnt_:TColor; var inds_obj_arr_,inds_sct_arr_:TColorArr);                                                    {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  Inc(obj_cnt_);
...
procedure   TSceneTree.Add                   (const koo:TKindOfObject; const world_axis_shift_:TPtPosF);                                                                                                       {$ifdef Linux}[local];{$endif} {$region -fold}
var
...
begin
 ...
 {SetLength(FilProc                 ,obj_cnt);
  ...
  SetLength(gr_not_sel_chld_inds_arr,obj_cnt);
  SetLength(vis_inds_arr0           ,obj_cnt);
  SetLength(vis_inds_arr1           ,obj_cnt);
  SetLength(vis_inds_arr2           ,obj_cnt);
  SetLength(obj_tags_arr            ,obj_cnt);}
  if  (Length(FilProc)                 <obj_cnt) then
    SetLength(FilProc                  ,obj_cnt+255);
  if  (Length(MovProc)                 <obj_cnt) then
    SetLength(MovProc                  ,obj_cnt+255);
  if  (Length(obj_arr)                 <obj_cnt) then
    SetLength(obj_arr                  ,obj_cnt+255);
  if  (Length(obj_inds_arr)            <obj_cnt) then
    SetLength(obj_inds_arr             ,obj_cnt+255);
  if  (Length(sel_inds_arr)            <obj_cnt) then
    SetLength(sel_inds_arr             ,obj_cnt+255);
  if  (Length(gr_not_sel_chld_inds_arr)<obj_cnt) then
    SetLength(gr_not_sel_chld_inds_arr ,obj_cnt+255);
  if  (Length(vis_inds_arr0)           <obj_cnt) then
    SetLength(vis_inds_arr0            ,obj_cnt+255);
  if  (Length(vis_inds_arr1)           <obj_cnt) then
    SetLength(vis_inds_arr1            ,obj_cnt+255);
  if  (Length(vis_inds_arr2)           <obj_cnt) then
    SetLength(vis_inds_arr2            ,obj_cnt+255);
  if  (Length(obj_tags_arr)            <obj_cnt) then
    SetLength(obj_tags_arr             ,obj_cnt+255);
  ...
  case koo of
    TKindOfObject(00){kooBkgnd}: SetFilMovProc(False,@FilBkgnd,@MovBkgnd,bkgnd_cnt,bkgnd_inds_obj_arr,bkgnd_inds_sct_arr);
    TKindOfObject(01){kooRGrid}: SetFilMovProc(False,@FilRGrid,@MovRGrid,rgrid_cnt,rgrid_inds_obj_arr,rgrid_inds_sct_arr);
    TKindOfObject(02){kooSGrid}: SetFilMovProc(False,@FilSGrid,@MovSGrid,sgrid_cnt,sgrid_inds_obj_arr,sgrid_inds_sct_arr);
    TKindOfObject(03){kooGroup}: SetFilMovProc(True ,@FilGroup,@MovGroup,group_cnt,group_inds_obj_arr,group_inds_sct_arr);
    TKindOfObject(04){kooTlMap}: SetFilMovProc(False,@FilTlMap,@MovTlMap,tlmap_cnt,tlmap_inds_obj_arr,tlmap_inds_sct_arr);
    TKindOfObject(05){kooActor}: SetFilMovProc(False,@FilActor,@MovActor,actor_cnt,actor_inds_obj_arr,actor_inds_sct_arr);
    TKindOfObject(06){kooPProc}: SetFilMovProc(False,@FilPProc,@MovPProc,pproc_cnt,pproc_inds_obj_arr,pproc_inds_sct_arr);
    TKindOfObject(07){kooCurve}: SetFilMovProc(False,@FilCurve,@MovCurve,curve_cnt,curve_inds_obj_arr,curve_inds_sct_arr);
    TKindOfObject(08){kooFtext}: SetFilMovProc(False,@FilFText,@MovFText,ftext_cnt,ftext_inds_obj_arr,ftext_inds_sct_arr);
  end;
  add_object:=True;
end; {$endregion}
procedure   TSceneTree.AddObjTag             (node_with_data:TTreeNode; const koot_:TKindOfObjectTag);                                                                                                         {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i,j,obj_ind,sel_obj_tags_arr_length: integer;
  s                                  : string;
begin
  obj_ind:=PNodeData(node_with_data.Data)^.g_ind;
  SetLength(obj_tags_arr[obj_ind],
     Length(obj_tags_arr[obj_ind])+1);
  with      obj_tags_arr[obj_ind]
    [Length(obj_tags_arr[obj_ind])-1] do
    case koot_ of
      kootMaterial       :
        begin
          SetLength              ( material_tags_data_arr        ,
             Length              ( material_tags_data_arr        )+1);
          obj_tag_data_ptr:=
          PMaterialTagData       (@material_tags_data_arr
                          [Length( material_tags_data_arr        )-1]);
        end;
      kootMarker         :
        begin
          SetLength              ( marker_tags_data_arr          ,
             Length              ( marker_tags_data_arr          )+1);
          obj_tag_data_ptr:=
          PMarkerTagData         (@marker_tags_data_arr
                          [Length( marker_tags_data_arr          )-1]);
        end;
      kootPointsSelection:
        begin
          SetLength              ( points_selection_tags_data_arr,
             Length              ( points_selection_tags_data_arr)+1);
          obj_tag_data_ptr:=
          PPointsSelectionTagData(@points_selection_tags_data_arr
                          [Length( points_selection_tags_data_arr)-1]);
        end;
      kootAnimation      :
        begin
          SetLength              ( animation_tags_data_arr       ,
             Length              ( animation_tags_data_arr       )+1);
          obj_tag_data_ptr:=
          PAnimationTagData      (@animation_tags_data_arr
                          [Length( animation_tags_data_arr       )-1]);
        end;
      kootSpecialEffect  :
        begin
          SetLength              ( special_effect_tags_data_arr  ,
             Length              ( special_effect_tags_data_arr  )+1);
          obj_tag_data_ptr:=
          PSpecialEffectTagData  (@special_effect_tags_data_arr
                          [Length( special_effect_tags_data_arr  )-1]);
        end;
      kootTrigger        :
        begin
          SetLength              ( trigger_tags_data_arr         ,
             Length              ( trigger_tags_data_arr         )+1);
          obj_tag_data_ptr:=
          PTriggerTagData        (@trigger_tags_data_arr
                          [Length( trigger_tags_data_arr         )-1]);
        end;
      kootCamera         :
        begin
          SetLength              ( camera_tags_data_arr          ,
             Length              ( camera_tags_data_arr          )+1);
          obj_tag_data_ptr:=
          PCameraTagData         (@camera_tags_data_arr
                          [Length( camera_tags_data_arr          )-1]);
        end;
      kootText           :
        begin
          SetLength              ( text_tags_data_arr            ,
             Length              ( text_tags_data_arr            )+1);
          obj_tag_data_ptr:=
          PTextTagData           (@text_tags_data_arr
                          [Length( text_tags_data_arr            )-1]);
        end;
      kootTilemap           :
        begin
          SetLength              ( tilemap_tags_data_arr         ,
             Length              ( tilemap_tags_data_arr         )+1);
          obj_tag_data_ptr:=
          PTilemapTagData        (@tilemap_tags_data_arr
                          [Length( tilemap_tags_data_arr         )-1]);
        end;
    end;
  s:=GetEnumName (TypeInfo(TKindOfObjectTag),Ord(koot_));
  j:=GetEnumValue(TypeInfo(TKindOfObjectTag),s);
  System.Delete(s,1,4);
      obj_tags_arr[obj_ind][Length(obj_tags_arr[obj_ind])-1].koot:=koot_;
      obj_tags_arr[obj_ind][Length(obj_tags_arr[obj_ind])-1].name:=s+' '+IntToStr
     (obj_tags_cnt[j]);
  Inc(obj_tags_cnt[j]);
  sel_obj_tags_arr_length:=0;
  for i:=0 to Length(obj_tags_arr)-1 do
            sel_obj_tags_arr_length+=
     Length(    obj_tags_arr[i]);
  SetLength(sel_obj_tags_arr,
            sel_obj_tags_arr_length);
end; {$endregion}
procedure   TSceneTree.SetObjBkgnd           (obj_arr_ptr:PObjProp; const bkgnd_ptr0,bkgnd_ptr1:PInteger; const bkgnd_width,bkgnd_height:TColor; const rct_clp_ptr:PPtRect);                                   {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  obj_arr_ptr^.bkgnd_ptr0  :=bkgnd_ptr0  ;
  obj_arr_ptr^.bkgnd_ptr1  :=bkgnd_ptr1  ;
  obj_arr_ptr^.bkgnd_width :=bkgnd_width ;
  obj_arr_ptr^.bkgnd_height:=bkgnd_height;
  obj_arr_ptr^.rct_clp_ptr :=rct_clp_ptr ;
end; {$endregion}
procedure   TSceneTree.SetObjBkgnd           (                      const bkgnd_ptr0,bkgnd_ptr1:PInteger; const bkgnd_width,bkgnd_height:TColor; const rct_clp_ptr:PPtRect; start_ind,end_ind:TColor);         {$ifdef Linux}[local];{$endif} {$region -fold}
var
  obj_arr_ptr     : PObjProp;
  obj_inds_arr_ptr: PColor;
  i               : integer;
...
procedure   TSceneTree.CrtNodeData           (node_with_data:TTreeNode; g_ind:TColor);                                                                                                                         {$ifdef Linux}[local];{$endif} {$region -fold}
var
...
procedure   TSceneTree.ClrNodeData           (node_with_data:TTreeNode);                                                                                                                                       {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  if (node_with_data.data<>Nil) then
    Dispose(PNodeData(node_with_data.data));
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProcArrInit;                                                                                                                                                                 {$ifdef Linux}[local];{$endif} {$region -fold}
begin
...
procedure   TSceneTree.WrtNodeDataProc00     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PByte(data_ptr0+data_shift)^:=Byte(data_write);
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc01     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PByte(data_ptr0+data_shift)^:=PByte(data_ptr1+data_shift)^;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc02     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PByte(data_ptr0+data_shift)^:=(PByte(data_ptr0+data_shift)^ and (not bit_mask)) or (Byte(data_write) and bit_mask);
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc03     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PByte(data_ptr0+data_shift)^:=PByte(data_ptr1+data_shift)^;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc04     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PBoolean(data_ptr0+data_shift)^:=Boolean(data_write);
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc05     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PBoolean(data_ptr0+data_shift)^:=PBoolean(data_ptr1+data_shift)^;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc06     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PWord(data_ptr0+data_shift)^:=Word(data_write);
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc07     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PWord(data_ptr0+data_shift)^:=PWord(data_ptr1+data_shift)^;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc08     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PLongWord(data_ptr0+data_shift)^:=LongWord(data_write);
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc09     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PLongWord(data_ptr0+data_shift)^:=PLongWord(data_ptr1+data_shift)^;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc10     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PShortInt(data_ptr0+data_shift)^:=ShortInt(data_write);
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc11     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PShortInt(data_ptr0+data_shift)^:=PShortInt(data_ptr1+data_shift)^;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc12     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PSmallInt(data_ptr0+data_shift)^:=SmallInt(data_write);
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc13     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PSmallInt(data_ptr0+data_shift)^:=PSmallInt(data_ptr1+data_shift)^;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc14     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PLongInt(data_ptr0+data_shift)^:=LongInt(data_write);
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc15     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PLongInt(data_ptr0+data_shift)^:=PLongInt(data_ptr1+data_shift)^;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc16     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PSingle(data_ptr0+data_shift)^:=Single(data_write);
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc17     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PSingle(data_ptr0+data_shift)^:=PSingle(data_ptr1+data_shift)^;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc18     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PDouble(data_ptr0+data_shift)^:=Double(data_write);
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc19     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PDouble(data_ptr0+data_shift)^:=PDouble(data_ptr1+data_shift)^;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc20     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PAnsiString(data_ptr0+data_shift)^:=AnsiString(data_write);
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc21     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PAnsiString(data_ptr0+data_shift)^:=PAnsiString(data_ptr1+data_shift)^;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc22     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtPosF(data_ptr0+data_shift)^.x:=TPtPosF(data_write).x;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc23     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtPosF(data_ptr0+data_shift)^.x:=PPtPosF(data_ptr1+data_shift)^.x;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc24     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtPosF(data_ptr0+data_shift)^.y:=TPtPosF(data_write).y;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc25     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtPosF(data_ptr0+data_shift)^.y:=PPtPosF(data_ptr1+data_shift)^.y;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc26     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtRect(data_ptr0+data_shift)^.left:=TPtRect(data_write).left;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc27     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtRect(data_ptr0+data_shift)^.left:=PPtRect(data_ptr1+data_shift)^.left;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc28     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtRect(data_ptr0+data_shift)^.top:=TPtRect(data_write).top;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc29     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtRect(data_ptr0+data_shift)^.top:=PPtRect(data_ptr1+data_shift)^.top;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc30     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtRect(data_ptr0+data_shift)^.width:=TPtRect(data_write).width;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc31     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtRect(data_ptr0+data_shift)^.width:=PPtRect(data_ptr1+data_shift)^.width;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc32     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtRect(data_ptr0+data_shift)^.height:=TPtRect(data_write).height;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc33     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtRect(data_ptr0+data_shift)^.height:=PPtRect(data_ptr1+data_shift)^.height;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc34     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtRect(data_ptr0+data_shift)^.right:=TPtRect(data_write).right;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc35     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtRect(data_ptr0+data_shift)^.right:=PPtRect(data_ptr1+data_shift)^.right;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc36     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtRect(data_ptr0+data_shift)^.bottom:=TPtRect(data_write).bottom;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc37     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtRect(data_ptr0+data_shift)^.bottom:=PPtRect(data_ptr1+data_shift)^.bottom;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc38     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtPos3(data_ptr0+data_shift)^.arr[0]:=TPtPos3(data_write).arr[0];
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc39     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtPos3(data_ptr0+data_shift)^.arr[0]:=PPtPos3(data_ptr1+data_shift)^.arr[0];
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc40     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtPos3(data_ptr0+data_shift)^.arr[1]:=TPtPos3(data_write).arr[1];
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc41     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtPos3(data_ptr0+data_shift)^.arr[1]:=PPtPos3(data_ptr1+data_shift)^.arr[1];
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc42     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtPos3(data_ptr0+data_shift)^.arr[2]:=TPtPos3(data_write).arr[2];
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc43     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtPos3(data_ptr0+data_shift)^.arr[2]:=PPtPos3(data_ptr1+data_shift)^.arr[2];
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc44     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtPos3(data_ptr0+data_shift)^.arr[3]:=TPtPos3(data_write).arr[3];
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc45     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtPos3(data_ptr0+data_shift)^.arr[3]:=PPtPos3(data_ptr1+data_shift)^.arr[3];
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc46     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtPos3(data_ptr0+data_shift)^.arr[4]:=TPtPos3(data_write).arr[4];
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc47     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtPos3(data_ptr0+data_shift)^.arr[4]:=PPtPos3(data_ptr1+data_shift)^.arr[4];
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc48     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtPos3(data_ptr0+data_shift)^.arr[5]:=TPtPos3(data_write).arr[5];
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc49     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtPos3(data_ptr0+data_shift)^.arr[5]:=PPtPos3(data_ptr1+data_shift)^.arr[5];
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc50     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtPos3(data_ptr0+data_shift)^.obj_ind:=TPtPos3(data_write).obj_ind;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc51     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtPos3(data_ptr0+data_shift)^.obj_ind:=PPtPos3(data_ptr1+data_shift)^.obj_ind;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc52     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtPos3(data_ptr0+data_shift)^.pts_ind:=TPtPos3(data_write).pts_ind;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc53     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtPos3(data_ptr0+data_shift)^.pts_ind:=PPtPos3(data_ptr1+data_shift)^.pts_ind;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc54     (const data_write; data_shift:integer; data_ptr0          :pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtPos3(data_ptr0+data_shift)^.dup_pts_cnt:=TPtPos3(data_write).dup_pts_cnt;
end; {$endregion}
procedure   TSceneTree.WrtNodeDataProc55     (const data_write; data_shift:integer; data_ptr0,data_ptr1:pointer);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
begin
  PPtPos3(data_ptr0+data_shift)^.dup_pts_cnt:=PPtPos3(data_ptr1+data_shift)^.dup_pts_cnt;
end; {$endregion}
procedure   TSceneTree.WrtNodeData           (const data_write; data_shift:integer; proc0:TProc21;proc1:TProc22);                                                                                              {$ifdef Linux}[local];{$endif} {$region -fold}
var
  obj_arr_ptr                 : PObjProp;
  obj_inds_arr_ptr            : PColor;
  sel_inds_arr_ptr            : PColor;
  gr_not_sel_chld_inds_arr_ptr: PColor;
  i                           : integer;
begin
  if (sel_cnt=0) then
    Exit;
  ...
  if (gr_not_sel_chld_cnt=0) then
    Exit;
  obj_arr_ptr                 :=Unaligned(@obj_arr                 [0]);
  obj_inds_arr_ptr            :=Unaligned(@obj_inds_arr            [0]);
  gr_not_sel_chld_inds_arr_ptr:=Unaligned(@gr_not_sel_chld_inds_arr[0]);
  for i:=0 to gr_not_sel_chld_cnt-1 do
    proc0(data_write,data_shift,PByte(obj_arr_ptr+(obj_inds_arr_ptr+(gr_not_sel_chld_inds_arr_ptr+i)^)^));
    {proc1(data_write,data_shift,PByte(obj_arr_ptr+(obj_inds_arr_ptr+000000000000000000000000000000000)^),
                                PByte(obj_arr_ptr+(obj_inds_arr_ptr+000000000000000000000000000000001)^));}
end; {$endregion}
// (Create array of indices of visible(in editor/in game) objects) Создать массив индексов видимых(в редакторе/в игре) обьектов:
{In editor}
procedure   TSceneTree.VisObjArrCrt0;                                                                                                                                                                          {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i: integer;
begin
  if (obj_cnt=0) then
  ...
  vis_inds_cnt0:=0;
  for i:=0 to obj_cnt-1 do
    if ((obj_arr[obj_inds_arr[i]].obj_show and %00000011) in [1,3]) then
      begin
        vis_inds_arr0[vis_inds_cnt0]:=obj_inds_arr[i];
        Inc(vis_inds_cnt0);
      end;
end; {$endregion}
{In game}
procedure   TSceneTree.VisObjArrCrt1;                                                                                                                                                                          {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i: integer;
begin
  if (obj_cnt=0) then
  ...
  vis_inds_cnt1:=0;
  for i:=0 to obj_cnt-1 do
    if ((obj_arr[obj_inds_arr[i]].obj_show and %00000011) in [2,3]) then
      begin
        vis_inds_arr1[vis_inds_cnt1]:=obj_inds_arr[i];
        Inc(vis_inds_cnt1);
      end;
end; {$endregion}
{In editor or game}
procedure   TSceneTree.VisObjArrCrt2;                                                                                                                                                                          {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i             : integer;
  editor_or_game: set of byte;
begin
  ...
  for i:=0 to obj_cnt-1 do
    begin
      case (obj_arr[obj_inds_arr[i]].obj_show and %00000011) of
        1:
          begin
            vis_inds_arr0[vis_inds_cnt0]:=obj_inds_arr[i];
            Inc(vis_inds_cnt0);
      ...
      if ((obj_arr[obj_inds_arr[i]].obj_show and %00000011) in editor_or_game) and
          (obj_arr[obj_inds_arr[i]].koo<>kooGroup) then
        begin
          vis_inds_arr2[vis_inds_cnt2]:={obj_inds_arr[}i{]};
          Inc(vis_inds_cnt2);
        end;
    end;
end; {$endregion}
...
function    TSceneTree.IsAnotherObjKindAfter1(const koo:TKindOfObject; const start_ind:TColor=0): boolean;                                                                                                     {$ifdef Linux}[local];{$endif} {$region -fold}
var
  obj_arr_ptr     : PObjProp;
  obj_inds_arr_ptr: PColor;
  i               : integer;
begin
  ...
  obj_arr_ptr     :=Unaligned(@obj_arr     [0]);
  obj_inds_arr_ptr:=Unaligned(@obj_inds_arr[0]);
  for i:=start_ind to obj_cnt{Length(obj_arr)}-1 do
    if ((obj_arr_ptr+(obj_inds_arr_ptr+i)^)^.koo<>koo) then
      Exit(True);
end; {$endregion}
function    TSceneTree.IsAnotherObjKindAfter2(                         const start_ind:TColor=0): boolean;                                                                                                     {$ifdef Linux}[local];{$endif} {$region -fold}
var
  obj_arr_ptr     : PObjProp;
  obj_inds_arr_ptr: PColor;
  i               : integer;
...
function    TSceneTree.IsAnotherObjKindAfter3(const koo:TKindOfObject; const start_ind:TColor=0): boolean;                                                                                                     {$ifdef Linux}[local];{$endif} {$region -fold}
var
  obj_arr_ptr     : PObjProp;
  obj_inds_arr_ptr: PColor;
  i               : integer;
...
function    TSceneTree.IsAnotherObjKindAfter4(const koo:TKindOfObject; const start_ind:TColor=0): boolean;                                                                                                     {$ifdef Linux}[local];{$endif} {$region -fold}
var
  obj_arr_ptr     : PObjProp;
  obj_inds_arr_ptr: PColor;
  i               : integer;
...
// (Calculate low and upper layer objects count) Подсчет количества обьектов "нижнего" и "верхнего" слоев:
function    TSceneTree.LowLrObjCntCalc1: TColor;                                                                                                                                                               {$ifdef Linux}[local];{$endif} {$region -fold}
var
  obj_arr_ptr     : PObjProp;
  obj_inds_arr_ptr: PColor;
  i               : integer;
  ...
  p_s1            : byte;
begin
  Result:=obj_cnt{Length(obj_inds_arr)};
  if (Result=1) then
    Exit;
  obj_arr_ptr     :=Unaligned(@obj_arr     [0]);
  obj_inds_arr_ptr:=Unaligned(@obj_inds_arr[0]);
  ...
  for i:=0 to obj_cnt{Length(obj_arr)}-1 do
...
procedure   TSceneTree.LowLrObjCntCalc2;                                                                                                                                                                       {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i: integer;
begin
  if (obj_cnt=0) then
    Exit;
  for i:=0 to low_lr_obj_cnt-1 do
    obj_arr[obj_inds_arr[i]].is_low_lr_obj:=True;
  for i:=low_lr_obj_cnt to obj_cnt-1 do
...
//
function    TSceneTree.TIndMin               (const obj_inds_arr_:TColorArr; const arr:TEdgeArr; const max_item_val:TColor; const item_cnt:TColor): TColor;                                                    {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i: integer;
begin
  Result:=max_item_val;
...
function    TSceneTree.TIndMin               (const obj_inds_arr_:TColorArr; const arr:TSlPtArr; const max_item_val:TColor; const item_cnt:TColor): TColor;                                                    {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i: integer;
begin
  Result:=max_item_val;
...
// (Bounding rectangle of points set) Ограничиваюший прямоугольник множества точек:
function    TSceneTree.PtsRngIndsRctCalc     (const pts:TPtPosFArr; const sel_pts_inds:TColorArr; const pts_cnt:TColor): TPtRectF;                                                                             {$ifdef Linux}[local];{$endif} {$region -fold}
var
  pts_ptr                                : PPtPosF;
...
procedure   TRecInfo.Assign (const rec_info:PTypeInfo; const bitp_fld_arr:T1Byte1Arr  );                                                                                                                                                      {$region -fold}
var
  i: integer;
begin
...
procedure   TRecInfo.MaskTo (const mask_val:T1Byte1Arr);                                                                                                                                                                                      {$region -fold}
begin
  SetLength(used_fld_inds_arr,NzBitCnt(mask_val,rec_flds_cnt));
  LinkArrIt(mask_val,used_fld_inds_arr);
end; {$endregion}
procedure   TRecInfo.CmpFil (const val:byte=1);                                                                                                                                                                                               {$region -fold}
var
  i: integer;
begin
...
procedure   TRecInfo.CmpRec0(const rec_ptr:pointer; const rec_instance_size,start_ind,instance_cnt,arr_length:integer                                );                                                                                       {$region -fold}
var
      ...
      begin
        ...
        for j:=0 to Length(cmp_it_arr[ind])-1 do
          begin
            ...
            for i:=start_ind to Min2(arr_length,start_ind+instance_cnt)-1 do
              begin
...
procedure   TRecInfo.CmpRec1(const rec_ptr:pointer; const rec_instance_size                                  :integer; const first_sel_node:TTreeNode);                                                                                       {$region -fold}
var
