...
type
  ...
  TSceneTree      =class         {$region -fold}
    public
      ...
      // Array of indices of objects which are not selected and have "Group" node as parent inside of scene tree:
     ...
     {procedure   MovSceneMT             (      rct_dst          :TPtRect;
      ...
      procedure   AddObjTag              (      node_with_data   :TTreeNode;
                                          const koot             :TKindOfObjectTag);            {$ifdef Linux}[local];{$endif}
...
procedure   TSceneTree.AddObjTag             (node_with_data:TTreeNode; const koot:TKindOfObjectTag);                                                                                                          {$ifdef Linux}[local];{$endif} {$region -fold}
var
...
begin
  ...
  s:=GetEnumName (TypeInfo(TKindOfObjectTag),Ord(koot));
  j:=GetEnumValue(TypeInfo(TKindOfObjectTag),s);
  System.Delete(s,1,4);
      obj_tags_arr[obj_ind][Length(obj_tags_arr[obj_ind])-1].koot:=koot;
  ...
  SetLength(sel_obj_tags_arr,sel_obj_tags_arr_length);
end; {$endregion}
