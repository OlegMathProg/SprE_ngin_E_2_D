...
type
  ...
  TSceneTree             =class         {$region -fold}
    public
      ...
      camera_tags_data_arr          : array of TCameraTagData; {$endregion}
     ...
     {procedure   MovSceneMT             (      rct_dst          :TPtRect;
      ...
      procedure   SetParallaxShift       (      parallax_shift_  :TPtPosF);                     {$ifdef Linux}[local];{$endif}
      procedure   SetParallaxShift       (      parallax_shift_  :TPtPosF;
                                                speed_mul        :TPtPosF);                     {$ifdef Linux}[local];{$endif}
...
procedure   TSceneTree.SetParallaxShift      (parallax_shift_  :TPtPosF);                                                                                                                                      {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i: integer;
begin
  if (obj_cnt=0) then
...
procedure   TSceneTree.SetParallaxShift      (parallax_shift_  :TPtPosF; speed_mul:TPtPosF);                                                                                                                   {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i: integer;
begin
  if (obj_cnt=0) then
