...
type
  ...
  TPProcProp      =packed record {$region -fold}
    pproc_obj_ind: TColor;
  end; {$endregion}
  PPProcProp      =^TPProcProp;
...
//
function    TSceneTree.Min9                  (const obj_inds_arr_:TColorArr; const arr:TEdgeArr; const max_item_val:TColor; const item_cnt:TColor): TColor;                                                    {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i: integer;
begin
  Result:=max_item_val;
...
function    TSceneTree.Min9                  (const obj_inds_arr_:TColorArr; const arr:TSlPtArr; const max_item_val:TColor; const item_cnt:TColor): TColor;                                                    {$ifdef Linux}[local];{$endif} {$region -fold}
var
  i: integer;
begin
  Result:=max_item_val;
